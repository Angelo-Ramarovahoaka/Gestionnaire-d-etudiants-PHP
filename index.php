...
<body class="bg-gray-100">
    ...
    <div class="login-container">
        <h1 class="text-2xl font-bold text-red-600 mb-4 text-center">Gestion des Étudiants</h1>
        <form id="login" action="controllers/userController.php?action=login" method="post">
            ...
            <div class="flex justify-between">
                <button class="bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-700" type="submit">Connexion</button>
                <a href="display/users/createUser.php" class="bg-red-600 text-white py-2 px-4 rounded-lg text-center block hover:bg-red-700">Inscription</a>
            </div>
        </form>   
    </div>
